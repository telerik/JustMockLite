...
namespace Telerik.JustMock.MSTest2.Tests
{
	...
	public class BehaviorFixture
	{
		...
		public void ShouldAssertMessageForNoSetupOnString()
		{
			...
			string expected = "Called unarranged member 'System.Guid GetGuid()' on strict mock of type 'Telerik.JustMock.MSTest2.Tests.BehaviorFixture+IFoo'";
		...
		public void ShouldRequireReturnValueInStrictMockArrangements()
		{
			...
			var expected = "Member 'Int32 GetInt32()' on strict mock of type 'Telerik.JustMock.MSTest2.Tests.BehaviorFixture+IFoo' has a non-void return value but no return value given in arrangement.";
		...
		public void ShouldAssertStrictMock()
		{
			...
			Assert.Equal("Called unarranged member 'System.Guid GetGuid()' on strict mock of type 'Telerik.JustMock.MSTest2.Tests.BehaviorFixture+IFoo'", message.Trim());
		}
