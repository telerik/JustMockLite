...
namespace Telerik.JustMock.MSTest2.Tests
{
	...
	public class NonPublicFixture
	{
		...
		public void ShouldProvideHelpfulExceptionMessageWhenNonPublicMethodIsMissing()
		{
			...
			Assert.Equal(("Method 'Do' with the given signature was not found on type Telerik.JustMock.MSTest2.Tests.NonPublicFixture+WeirdSignature\r\n" +
...
"VB: Mock.NonPublic.Arrange(Of Integer)(\"Do\", ArgExpr.IsAny(Of Char)())\r\n").Replace("\r\n", Environment.NewLine), message);
			...
			Assert.Equal(("Method 'Dont' with the given signature was not found on type Telerik.JustMock.MSTest2.Tests.NonPublicFixture+WeirdSignature\r\n" +
