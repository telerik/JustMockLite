...
namespace Telerik.JustMock.Expectations.Abstraction
{
    ...
    /// </summary>
    /// <typeparam name="TReturn">Return type of the arranged member.</typeparam>
    public interface IReturns<TReturn>
    {
        ...
        /// <returns>Reference to <see cref="IAssertable"/> interface so that you can continue the arrangement.</returns>
