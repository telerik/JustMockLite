...
namespace Telerik.JustMock.Core.Castle.DynamicProxy
{
    ...
    internal class ModuleScope
    {
        ...
        public static byte[] GetKeyPair()
        {
            ...
            using (var stream = typeof(ModuleScope).GetTypeInfo().Assembly.GetManifestResourceStream(snkeyName))
            {
                if (stream == null)
                {
                    throw new MissingManifestResourceException(
                        "Should have a "+ snkeyName + " as an embedded resource, so Dynamic Proxy could sign generated assembly");
                }
